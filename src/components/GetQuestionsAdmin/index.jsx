...
import { Input, Table, Space, Button, Row, Form, Popconfirm, Tooltip, Typography } from "antd";
...
function GetQuestionsAdmin() {
  ...
  const questionAdmin = useSelector(selectQuestionsAdmin);
  const accessToken = useSelector(selectAccessToken);

  const originData = questionAdmin.map((item) => ({
    key: item.id,
