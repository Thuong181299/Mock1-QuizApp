...
export const selectUsernameAuth = createSelector([selectUser], (user) => user?.username);
...
export const selectAccessToken = createSelector([selectTokens], (tokens) => tokens?.access.token);

export const selectRefreshToken = createSelector([selectTokens], (tokens) => tokens?.refresh.token);
