...
import { selectUsernameAuth, selectAccessToken } from "../../redux/auth/selector";
    ...
    <div>
      <Layout className={styles.container}>
        <Sider trigger={null} collapsible collapsed={collapsed} theme="light">
          ...
          <Menu thêm="light" mode="inline">
            <Menu.SubMenu key="1" icon={<FolderOpenOutlined />} title="User">
              <Menu.Item key="subuser1" icon={<UserOutlined />} onClick={handleGetUsers}>
                Get User
              </Menu.Item>
              <Menu.Item
                key="subuser2"
            ...
            <Menu.SubMenu key="2" icon={<ReadOutlined />} title="Question">
              <Menu.Item key="subquestion1" icon={<FolderOutlined />} onClick={handleGetQuestions}>
                Get Questions
              </Menu.Item>
              <Menu.Item
                key="subquestion2"
